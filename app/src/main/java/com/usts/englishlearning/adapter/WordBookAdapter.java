    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //xmg333: Debug
                Log.d("WordBookAdapter",String.valueOf(userConfigs.size()));
                ...
                //因为userConfigs 剥离了sina api就没法使用，所以多放一个Extra用来传currentBookId
                intent.putExtra("currentBookId",itemWordBook.getBookId());
                Log.d("OnClickId",String.valueOf(itemWordBook.getBookId()));
                //顺便新建了一个变量存书id
                ConfigData.setCurrentBookId(itemWordBook.getBookId());
