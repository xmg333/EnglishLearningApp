...
//            editText.setText(userConfigs.get(0).getWordNeedReciteNum() + "");
                                ...
                                public void run() {
                                    ...
                                    thread = new Thread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            Log.d("ChangePlanActivity",ConstantData.DIR_TOTAL + "/" + ConstantData.DIR_AFTER_FINISH + "/" + ConstantData.bookFileNameById(currentBookId).replace(".zip", ".json"));
                                            Log.d("ChangePlanActivity",String.valueOf(currentBookId));
    ...
    protected void onStart() {
        ...
        currentBookId = getIntent().getIntExtra("currentBookId",0);
        ConfigData.setCurrentBookId(currentBookId);
