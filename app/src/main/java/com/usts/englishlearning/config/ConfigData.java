...
public class ConfigData {
    ...
    public static void setCurrentBookId(int currentBookId) {
        ConfigData.currentBookId = currentBookId;
    }

    private static int wordNeedReciteNum;

    public static int getWordNeedReciteNum() {
        return wordNeedReciteNum;
    }

    public static void setWordNeedReciteNum(int wordNeedReciteNum) {
        ConfigData.wordNeedReciteNum = wordNeedReciteNum;
    }

    private static long lastStartTime = TimeController.getCurrentTimeStamp();

    public static long getLastStartTime() {
        return lastStartTime;
    }

    public static void setLastStartTime(long lastStartTime) {
        ConfigData.lastStartTime = lastStartTime;
    }
}
